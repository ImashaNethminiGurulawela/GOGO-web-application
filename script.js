...
function openCartModal() {
                              // Select the element with the ID 'cartModal' and set its display style to 'block'
                              // This makes the cart modal visible on the screen.
document.getElementById('cartModal').style.display = 'block';
displayCartModal();           // Call the displayCartModal() function to refresh the cart contents in the modal
                              // This ensures that the modal shows the most up-to-date information about the items in the cart.
}
